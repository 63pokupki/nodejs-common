...
class RabbitSenderSys {
    ...
    async Init(confConnect, queryList) {
        ...
        return new Promise((resolve, reject) => {
            ...
            amqp.connect(confConnect, async (error0, connection) => {
                ...
                if (exports.rabbitSenderSys.vWatchChannel) {
                    const vWatchCannel = exports.rabbitSenderSys.vWatchChannel;
                    const vCannel = exports.rabbitSenderSys.aQuery[vWatchCannel.queryName].channel;
    ...
    watchChannel(queryName, channelCount, faAction) {
        exports.rabbitSenderSys.vWatchChannel = {
            queryName,
            channelCount,
            faAction,
        };
