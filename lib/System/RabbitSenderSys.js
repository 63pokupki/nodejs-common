...
class RabbitSenderSys {
    ...
    async Init(confConnect, queryList) {
        ...
        return new Promise((resolve, reject) => {
            ...
            amqp.connect(confConnect, async function (error0, connection) {
                ...
                if (exports.rabbitSenderSys.vWatchCannel) {
                    const vWatchCannel = exports.rabbitSenderSys.vWatchCannel;
                    let vCannel = exports.rabbitSenderSys.aQuery[vWatchCannel.queryName].channel;
     ...
     * @param faAction
     */
    watchCannel(queryName, chanelCount, faAction) {
        exports.rabbitSenderSys.vWatchCannel = {
            queryName: queryName,
    ...
    getChannel(queryName) {
        let vChannel = null;
        try {
            vChannel = exports.rabbitSenderSys.aQuery[queryName].channel;
        }
        catch (e) {
