...
const P63UserVisitSQL_1 = require("../Infrastructure/SQL/Repository/P63UserVisitSQL");
/**
...
class UserSys {
    constructor(req) {
        ...
        this.p63UserVisitSQL = new P63UserVisitSQL_1.P63UserVisitSQL(req);
        this.ctrlAccessList = {};
        this.userGroupsList = {};
        this.accessCRUDList = {};
        /* вылавливаем apikey */
    ...
    async init() {
        ...
        if (ok) { // Проиндексировать модули по: alias модуля
            _.forEach(ctrlAccessListTemp, (v) => {
